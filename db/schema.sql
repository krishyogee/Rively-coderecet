...
CREATE TABLE public.newsletters (
    id integer NOT NULL,
    newsletter_uid uuid DEFAULT public.uuid_generate_v4() NOT NULL,
...
--
-- Name: newsletters newsletters_newsletter_uid_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.newsletters
    ADD CONSTRAINT newsletters_newsletter_uid_key UNIQUE (newsletter_uid);
...
--
-- Name: newsletters fk_newsletter_customer; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.newsletters
    ADD CONSTRAINT fk_newsletter_customer FOREIGN KEY (customer_uid) REFERENCES public.customers(customer_uid);


--
-- Name: newsletters fk_newsletter_department; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.newsletters
    ADD CONSTRAINT fk_newsletter_department FOREIGN KEY (department_uid) REFERENCES public.departments(department_uid);
